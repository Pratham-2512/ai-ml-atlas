    ...
    <header className="hero">
      <div className="wrap hero-inner">
        <div className="hero-copy">
          ...
          <p className="dek">
            I collected the courses, papers, and projects I wish I had when I started. Everything is checked by
            hand and organized into a path you can actually follow.
          </p>
